...
- Browse to and load **bph_mixmod.smu** file to load a simulation that creates a figure similar to Fig6C from the paper
- Click "Start"

See [http://snnap.uth.tmc.edu/downloads.htm](http://snnap.uth.tmc.edu/downloads.htm) to download SNNAP
